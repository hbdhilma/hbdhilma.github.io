...
const startDate = new Date(2022, 0, 27, 00, 00, 00).getTime(); // initial date and time the countdown clock started from (Year, Month, Day, Hours, Minutes, Seconds,)
...
function liveStream() {
    window.location.assign("https://hbdhilma.github.io/wish");
}